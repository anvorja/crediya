...
//
//@ExtendWith(MockitoExtension.class)
//@DisplayName("Integración - Crear Solicitud UseCase con Manejo Inteligente de Errores")
//class CrearSolicitudIntegrationTest {
//
//    @Mock
//    private SolicitudRepository solicitudRepository;
...
//
//    @Nested
//    @DisplayName("Manejo Inteligente de Errores")
//    class ManejoInteligenteErrores {
//
//        @Test
//        @DisplayName("Debe FALLAR el flujo con errores CRÍTICOS de validación")
//        void debeFallarFlujoConErroresCriticos() {
//            // Given
//            Solicitud solicitud = crearSolicitudValida();
//            when(validacionExternaGateway.validarDocumento(anyString()))
//                    .thenReturn(Mono.error(new RuntimeException("Error externo")));
//
//            // When & Then - Error crítico debe fallar todo el flujo
//            StepVerifier.create(useCase.ejecutar(solicitud))
//                    .expectError(RuntimeException.class)
//                    .verify();
//
//            // Verificar que NO se guardó nada cuando hay error crítico
//            verify(solicitudRepository, never()).guardar(any());
//        }
//
//        @Test
//        @DisplayName("Debe FALLAR con errores de seguridad (blacklist)")
//        void debeFallarConErroresSeguridad() {
//            // Given
//            Solicitud solicitud = crearSolicitudValida();
//            when(validacionExternaGateway.validarDocumento(anyString()))
//                    .thenReturn(Mono.error(new SecurityException("Documento en blacklist")));
//
//            // When & Then
//            StepVerifier.create(useCase.ejecutar(solicitud))
//                    .expectError(RuntimeException.class)
...
//
//        @Test
//        @DisplayName("Debe FALLAR con errores de fraude")
//        void debeFallarConErroresFraude() {
//            // Given
//            Solicitud solicitud = crearSolicitudValida();
//            when(validacionExternaGateway.validarDocumento(anyString()))
//                    .thenReturn(Mono.error(new RuntimeException("Fraude detectado")));
//
//            // When & Then
//            StepVerifier.create(useCase.ejecutar(solicitud))
//                    .expectError(RuntimeException.class)
...
//
//        @Test
//        @DisplayName("Debe CONTINUAR con errores RECUPERABLES de historial")
//        void debeContinuarConErroresRecuperables() {
//            // Given
//            Solicitud solicitud = crearSolicitudValida();
//            when(validacionExternaGateway.consultarHistorialCrediticio(anyString()))
//                    .thenReturn(Mono.error(new RuntimeException("Database unavailable")));
//
//            // When & Then - Error recuperable se convierte en observación
//            StepVerifier.create(useCase.ejecutar(solicitud))
//                    .expectNextMatches(result -> result.getId() != null)
//                    .verifyComplete();
//
//            // Verificar que SÍ se guardó la solicitud con error recuperable
//            verify(solicitudRepository, times(1)).guardar(any());
//        }
//
//        @Test
//        @DisplayName("Debe CONTINUAR con errores TEMPORALES de conectividad")
//        void debeContinuarConErroresTemporales() {
//            // Given
//            Solicitud solicitud = crearSolicitudValida();
//            when(validacionExternaGateway.validarInformacionFinanciera(anyString(), any()))
//                    .thenReturn(Mono.error(new java.net.ConnectException("Network timeout")));
//
//            // When & Then - Error temporal no debe afectar el flujo
//            StepVerifier.create(useCase.ejecutar(solicitud))
//                    .expectNextMatches(result -> result.getId() != null)
//                    .verifyComplete();
//        }
...
//
//        @Test
//        @DisplayName("Debe manejar múltiples tipos de errores en secuencia")
//        void debeManejarMultiplesTiposErrores() {
//            // Given
//            Solicitud solicitud = crearSolicitudValida();
//
//            // Error recuperable en historial crediticio
//            when(validacionExternaGateway.consultarHistorialCrediticio(anyString()))
//                    .thenReturn(Mono.error(new RuntimeException("Database temporarily unavailable")));
//
//            // Error temporal en validación financiera
//            when(validacionExternaGateway.validarInformacionFinanciera(anyString(), any()))
//                    .thenReturn(Mono.error(new java.net.SocketTimeoutException("Request timeout")));
//
//            // When & Then - Debe continuar con observaciones del error recuperable
//            StepVerifier.create(useCase.ejecutar(solicitud))
//                    .expectNextMatches(result -> result.getId() != null)
//                    .verifyComplete();
//        }
